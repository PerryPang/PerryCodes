...
<head>
    ...
    <!-- <![endif]-->
    <!--[if IE]>
    <script type="text/javascript">window.jQuery || document.write("<script src='${ctx}/static/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
    <![endif]-->
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    <li class="home"><a href="javascript:void(0)" name="${ctx}/task/home" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                    <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 监控任务 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a  href="javascript:void(0)" name="${ctx}/task/list"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>劫持监控</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="main-content">
            ...
            <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="${ctx}/task/home">  </iframe>
...
<div class="footer_style" id="footerstyle">
    ...
    <p class="l_f">AK后台任务系统</p>
    <p class="r_f">更多功能开发中...</p>
</div>
